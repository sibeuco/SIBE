...
public final class ArchivoConstante {
    ...
    public static final String COLUMNA_EMPLEADO_IDENTIFICACION = "IDENTIFICACION";
    public static final String COLUMNA_EMPLEADO_ID_CARNET = "#_CHIP";
    public static final String COLUMNA_EMPLEADO_COD_CLASIFICACION_7 = "CODIGO_CLASIFICACION_7";
    public static final String COLUMNA_EMPLEADO_GRUPO_RELACION_LABORAL = "GRUPO_RELACION_LABORAL";
    public static final String COLUMNA_EMPLEADO_COD_CENTRO_COSTOS = "CODIGO_CENTRO_COSTOS";
    public static final String COLUMNA_EMPLEADO_CENTRO_COSTOS_N1 = "CENTRO_COSTOS_N1";
    public static final String COLUMNA_EMPLEADO_COD_CIUDAD_RESIDENCIA = "CODIGO_CIUDAD_RESIDENCIA";
    ...
    public static final String COLUMNA_ESTUDIANTE_ANNO_INGRESO = "ANO_INGRESO";
