...
public final class MensajesValidacionConstante {
    ...
    public static final String CONTRASENA_LONGITUD_MINIMA = "La contraseña debe tener al menos 8 caracteres.";
    public static final String CONTRASENA_REQUIERE_MAYUSCULA = "La contraseña debe incluir al menos una letra mayúscula.";
    public static final String CONTRASENA_REQUIERE_MINUSCULA = "La contraseña debe incluir al menos una letra minúscula.";
    public static final String CONTRASENA_REQUIERE_NUMERO = "La contraseña debe incluir al menos un número.";
