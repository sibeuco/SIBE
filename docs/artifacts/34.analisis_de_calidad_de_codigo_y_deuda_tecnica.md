...
6. [Diagrama de Distribución de Issues](#7-diagrama-de-distribución-de-issues)
7. [Plan de Remediación Priorizado](#8-plan-de-remediación-priorizado)
8. [Historial de Cambios](#9-historial-de-cambios)
...
**Ajuste realizado:** El tiempo de vida de JWT ya se redujo a 4 horas, este valor se seleccionó debido a la duración de las actividades, que en algunos casos, podría superar los 30 minutos.
...
#### 🟠 R-01 — Campo muerto (dead code) en LoginUseCase
...
#### 🟠 R-02 — Consulta doble a base de datos en LoginUseCase
...
#### 🟡 R-03 — Llamada sin efecto (dead statement)
...
#### 🟡 R-04 — Retorno null en lugar de Optional a través de ~24 repositorios
...
#### 🟠 FE-S02 — Lógica de parseo JWT duplicada en 4+ archivos
...
#### 🟠 FE-A02 — Manipulación directa del DOM para gestión de modales Bootstrap
...
#### 🟡 FE-A03 — Ausencia de `trackBy` en listas con `*ngFor`
...
#### 🟡 FE-A04 — Métodos HTTP mixtos en ActivityService
...
#### 🟡 FE-A05 — Carga paralela no aprovechada en FilterListComponent
...
## 6. Diagrama de Distribución de Issues
...
| 6 | FE-H01 | Eliminar todos los `console.log` marcados con `// Debug log` en `edit-user.component.ts` + otros | Frontend Dev |
